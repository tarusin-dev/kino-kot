        ...
        <div className={styles['privacy__container']}>
          ...
          <section className={styles['privacy__section']}>
            ...
            <ul>
              ...
              <li>Анализа использования Сервиса и улучшения пользовательского опыта, если вы дали согласие на аналитику</li>
          ...
          <section className={styles['privacy__section']}>
            ...
            <p>
              ...
              аналитические cookie. В cookie-баннере можно принять все cookie,
              отклонить аналитику или открыть настройки и сохранить отдельный
              выбор по аналитике. Если вы отклоняете аналитику, сайт продолжает
