    ...
    <>
      ...
      <main className={styles['privacy']}>
        <div className={styles['privacy__container']}>
          ...
          <p className={styles['privacy__updated']}>Последнее обновление: 24 апреля 2026 г.</p>
          ...
          <section className={styles['privacy__section']}>
            ...
            <ul>
              ...
              <li><strong>Аналитические данные:</strong> обезличенные данные о посещениях и действиях на сайте через Google Analytics</li>
            </ul>
          </section>
          ...
          <section className={styles['privacy__section']}>
            ...
            <p>
              ...
              авторизации (access token и refresh token), а также аналитические
              инструменты Google Analytics для обезличенного анализа посещаемости.
              Для сценария гостевых отзывов браузер может хранить локальный guest token
              в `localStorage`, который не используется для рекламы и нужен только для
              предотвращения повторной отправки отзыва на один и тот же фильм.
            </p>
          </section>
          ...
          <section className={styles['privacy__section']}>
            ...
            <p>
              ...
              Для аналитики сайт использует Google Analytics, который получает
              обезличенные данные о посещениях в объёме, необходимом для работы сервиса аналитики.
            </p>
          </section>
